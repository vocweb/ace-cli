...
/// Shared test utility: a single process-wide mutex for tests that change the current
/// working directory. All test modules must use this same lock to avoid races with
/// cwd-sensitive session operations.
#[cfg(test)]
