...
pub struct SessionStore {
    ...
    /// `/home/user/project/.ace/sessions/a1b2c3d4e5f60718/`.
...
impl SessionStore {
    ...
    ///
    /// The on-disk layout becomes `<cwd>/.ace/sessions/<workspace_hash>/`.
...
pub fn managed_sessions_dir_for(
    ...
    let path = base_dir.as_ref().join(".ace").join("sessions");
